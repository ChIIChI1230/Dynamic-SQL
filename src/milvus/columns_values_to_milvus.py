...
COLLECTION_NAME = "bird_columns_search_from_values"
...
schema.add_field(field_name="column_value", datatype=DataType.VARCHAR, max_length=2048)
schema.add_field(field_name="column_value_vector", datatype=DataType.FLOAT_VECTOR, dim=1024)
...
data = {}
with open("./milvus/columns_values_milvus.json", "r") as f:
    data = json.load(f)
print(len(data))
