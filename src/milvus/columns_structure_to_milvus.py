...
COLLECTION_NAME = "bird_columns_search"
...
schema.add_field(field_name="column_name", datatype=DataType.VARCHAR, max_length=2048)
schema.add_field(field_name="column_name_vector", datatype=DataType.FLOAT_VECTOR, dim=1024)
...
data = {}
with open("./milvus/columns_structure_milvus.json", "r") as f:
    data = json.load(f)
print(len(data))
